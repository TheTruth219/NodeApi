...
// Show a header for the help page that is a s wide as the screen
 cli.horizontalLine();
 cli.centered('CLI MANUAL');
 cli.horizontalLine();
 cli.verticalSpace(2);

 // Show each commmand, followed by it's explanation, in white and yellow respectively
...
// List logs - traditional way (option)
...
cli.responders.moreLogInfo = (str)=>{
  ...
  // ONly process input if the user actually wrote something. Otherwise ignore
  if(str){
