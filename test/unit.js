...
// Logs.list should callback an array and a false console.error;
...
unit['logs.truncate should not throw if the logId doesn\'t exist. It should callback in error instead.'] = done =>{
  assert.doesNotThrow(()=>{
...
unit['exampleDebuggingProblem.init should not throw if the logId doesn\'t exist. It should callback in error instead.'] = done =>{
  assert.doesNotThrow(()=>{
